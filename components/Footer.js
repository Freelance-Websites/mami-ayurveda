      ...
      >
        ...
        <ul class="flex items-center">
          <li class="pr-3">
            ...
            >
              <svg width="18" height="12" viewBox="0 0 18 12" fill="none" class="fill-current" xmlns="http://www.w3.org/2000/svg">
          ...
          <li class="pr-3">
            <a
              ...
              className="text-white/80 mt-4 md:mt-0 ml-4"
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" class="fill-current" xmlns="http://www.w3.org/2000/svg">
