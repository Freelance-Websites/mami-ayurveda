      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            ...
            {/* Gmail requirement warning for courses */}
            {product.category === 'cursos-y-talleres' && (
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-amber-700">
                      <strong>Importante:</strong> Para acceder a la plataforma del curso necesitás tener una cuenta de Gmail válida, ya que utilizamos Google Classroom como aula virtual.
                    </p>
                  </div>
                </div>
              </div>
